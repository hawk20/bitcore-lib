...
var Input = ufocore.Transaction.Input;
var Output = ufocore.Transaction.Output;
var PrivateKey = ufocore.PrivateKey;
var Script = ufocore.Script;
var Address = ufocore.Address;
var Networks = ufocore.Networks;
var Opcode = ufocore.Opcode;
var errors = ufocore.errors;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(ufocore.Transaction.Input.PublicKey);
  ...
  describe('checked serialize', function() {
    ...
    describe('skipping checks', function() {
      ...
      it('can skip the check that avoids spending more ufocoins than the inputs for a transaction', buildSkipTest(
        function(transaction) {
          return transaction
            .to(toAddress, 10000000000000)
            .change(changeAddress)
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(ufocore.Script);
  ...
  describe('BIP69 Sorting', function() {
    ...
    describe('ufocoinjs fixtures', function() {
