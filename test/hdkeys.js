...
var HDPrivateKey = ufocore.HDPrivateKey;
var HDPublicKey = ufocore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  it('should use full 32 bytes for private key data that is hashed (as per bip32)', function() {
    // https://github.com/ufocoin/bips/blob/master/bip-0032.mediawiki
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = ufocore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(ufocore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(ufocore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      ufocore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = ufocore.PublicKey.fromPoint;
      ufocore.PublicKey.fromPoint = function() {
        ufocore.PublicKey.fromPoint = unstubbed;
...
//test vectors: https://github.com/ufocoin/bips/blob/master/bip-0032.mediawiki
