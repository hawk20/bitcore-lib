...
/**
 * Retrieve a hexa string that can be used with ufocoind's CLI interface
 ...
 * * `disableMoreOutputThanInput`: disable checking if the transaction spends more ufocoins than the sum of the input amounts
 * @return {string}
 */
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'https://ufocore.io/api/lib/transaction#serialization-checks';
 ...
 *
 * Can receive, as output information, the output of ufocoind's `listunspent` command,
 * and a slightly fancier format recognized by ufocore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a ufocore Address object. The
 * same is true for `script`, which can be a string or a ufocore Script.
 *
 ...
 *
 * // From a pay to public key hash output from ufocoind's listunspent
 ...
 *
 * @see {https://github.com/ufocoin/bips/blob/master/bip-0069.mediawiki}
 * @return {Transaction} this
 */
 ...
 * CheckTransaction in ufocoin core.
 */
...
/**
 * Analogous to ufocoind's IsCoinBase function in transaction.h
 */
