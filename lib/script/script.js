...
/**
 * A ufocoin transaction script. Each transaction's inputs and outputs
 * has a script that is evaluated to validate it's spending.
 *
 * See https://en.ufocoin.it/wiki/Script
 *
 * @constructor
...
/**
 * Analogous to ufocoind's FindAndDelete. Find and delete equivalent chunks,
...
/**
 * Comes from ufocoind's script interpreter CheckMinimalPush function
...
/**
 * Comes from ufocoind's script DecodeOP_N function
 * @param {number} opcode
...
/**
 * Comes from ufocoind's script GetSigOpCount(boolean) function
