# Public Key
Represents a ufocoin public key and is needed to be able to receive ufocoin, as is usually represented as a ufocoin [Address](address.md). See the official [Bitcoin Wiki](https://en.ufocoin.it/wiki/Technical_background_of_version_1_Bitcoin_addresses).
...
A public key point should be on the [secp256k1](https://en.ufocoin.it/wiki/Secp256k1) curve, instantiating a new PublicKey will validate this and will throw an error if it's invalid. To check that a public key is valid:
...
> var compressedPK = ufocore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new ufocore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = ufocore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
